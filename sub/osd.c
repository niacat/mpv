...
static const m_option_t style_opts[] = {
    {"font", OPTF_STRING(font)},
    {"font-size", OPTF_FLOAT(font_size), .min = 1, .max = 9000},
    {"color", OPTF_COLOR(color)},
    {"border-color", OPTF_COLOR(border_color)},
    {"shadow-color", OPTF_COLOR(shadow_color)},
    {"back-color", OPTF_COLOR(back_color)},
    {"border-size", OPTF_FLOAT(border_size)},
    {"shadow-offset", OPTF_FLOAT(shadow_offset)},
    {"spacing", OPTF_FLOAT(spacing), .min = -10, .max = 10},
    {"margin-x", OPTF_INT(margin_x), .min = 0, .max = 300},
    {"margin-y", OPTF_INT(margin_y), .min = 0, .max = 600},
    {"align-x", OPTF_CHOICE(align_x,
     ({"left", -1}, {"center", 0}, {"right", +1}))},
    {"align-y", OPTF_CHOICE(align_y,
     ({"top", -1}, {"center", 0}, {"bottom", +1}))},
    {"blur", OPTF_FLOAT(blur), .min = 0, .max = 20},
    {"bold", OPTF_FLAG(bold)},
    {"italic", OPTF_FLAG(italic)},
    {"justify", OPTF_CHOICE(justify,
     ({"auto", 0}, {"left", 1}, {"center", 2}, {"right", 3}))},
    {"font-provider", OPTF_CHOICE(font_provider,
