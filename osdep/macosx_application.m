    ...
    .opts = (const struct m_option[]) {
        ...
        OPT_CHOICE("macos-title-bar-material", macos_title_bar_material, 0,
                   ({"titlebar", 0}, {"selection", 1}, {"menu", 2},
                    ...
                    {"ultraDark", 17})),
        {"macos-title-bar-color", OPTF_COLOR(macos_title_bar_color)},
        OPT_CHOICE_OR_INT("macos-fs-animation-duration",
                          macos_fs_animation_duration, 0, 0, 1000,
                          ({"default", -1})),
        {"macos-force-dedicated-gpu", OPTF_FLAG(macos_force_dedicated_gpu)},
        {"cocoa-cb-sw-renderer", OPTF_CHOICE(cocoa_cb_sw_renderer,
         ({"auto", -1}, {"no", 0}, {"yes", 1}))},
        {"cocoa-cb-10bit-context", OPTF_FLAG(cocoa_cb_10bit_context)},
