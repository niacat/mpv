...
static const struct m_option opts[] = {
    {"prefer-stretchrect", OPTF_FLAG(opt_prefer_stretchrect)},
    {"disable-textures", OPTF_FLAG(opt_disable_textures)},
    {"disable-stretchrect", OPTF_FLAG(opt_disable_stretchrect)},
    {"disable-shaders", OPTF_FLAG(opt_disable_shaders)},
    {"only-8bit", OPTF_FLAG(opt_only_8bit)},
    {"force-power-of-2", OPTF_FLAG(opt_force_power_of_2)},
    {"disable-texture-align", OPTF_FLAG(opt_disable_texture_align)},
    OPT_CHOICE("texture-memory", opt_texture_memory, 0,
               ({"default", 0},
                ...
                {"scratch", 4})),
    {"swap-discard", OPTF_FLAG(opt_swap_discard)},
    {"exact-backbuffer", OPTF_FLAG(opt_exact_backbuffer)},
    {0}
};
