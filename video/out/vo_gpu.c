...
static const m_option_t options[] = {
    {"gpu-context", OPTF_STRING_VALIDATE(context_name, ra_ctx_validate_context)},
    {"gpu-api", OPTF_STRING_VALIDATE(context_type, ra_ctx_validate_api)},
    {"gpu-debug", OPTF_FLAG(opts.debug)},
    {"gpu-sw", OPTF_FLAG(opts.allow_sw)},
    {0}
};
