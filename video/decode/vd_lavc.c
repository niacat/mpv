...
const struct m_sub_options vd_lavc_conf = {
    .opts = (const m_option_t[]){
        {"vd-lavc-fast", OPTF_FLAG(fast)},
        {"vd-lavc-show-all", OPTF_FLAG(show_all)},
        ...
        {"vd-lavc-bitexact", OPTF_FLAG(bitexact)},
        {"vd-lavc-assume-old-x264", OPTF_FLAG(old_x264)},
        {"vd-lavc-check-hw-profile", OPTF_FLAG(check_hw_profile)},
        OPT_CHOICE_OR_INT("vd-lavc-software-fallback", software_fallback,
                          0, 1, INT_MAX, ({"no", INT_MAX}, {"yes", 1})),
        {"vd-lavc-o", OPTF_KEYVALUELIST(avopts)},
        {"vd-lavc-dr", OPTF_FLAG(dr)},
        OPT_STRING_VALIDATE("hwdec", hwdec_api,
                            M_OPT_OPTIONAL_PARAM | UPDATE_HWDEC,
                            hwdec_validate_opt),
        {"hwdec-codecs", OPTF_STRING(hwdec_codecs)},
        OPT_IMAGEFORMAT("hwdec-image-format", hwdec_image_format, 0, .min = -1),
        {"hwdec-extra-frames", OPTF_INT(hwdec_extra_frames), .min = 0, .max = 256},
        {0}
    },
